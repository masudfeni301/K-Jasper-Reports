...
DEPT_GROUP, DEPT_CODE, DESIG_CODE, DESIG_GROUP, DEPT_GROUP_SL
(CASE 
...
MOBILE_AC_DATE, DEPT_GROUP, DEPT_CODE, DESIG_CODE, DESIG_GROUP, JOIN_DT, DEPT_GROUP_SL,
...
ORDER BY 
DEPT_GROUP_SL, DEPT_GROUP, DEPT_CODE, DESIG_CODE, ATTEND_DATE
